...
The dataset is already clean, so the emphasis of this lab is on:
- Understanding the data through exploration  
- Identifying relevant features  
- Preparing the data for modeling  
- Building a regression model to capture relationships between variables  

Through this process, we aim to understand which factors contribute most to customer spending and evaluate how well a linear model can predict it.
